module Swagger::ConsultancySchema
  extend ActiveSupport::Concern
  include Swagger::Blocks

  included do
    swagger_schema :Consultancy do
      property :title do
        key :type, :string
      end
      ...
      property :consultation_date do
        key :type, :string
        key :format, :date
      end
      property :consulting_objective do
        key :type, :string
      end
    ...
    swagger_schema :ConsultancyInputPost do
      allOf do
        schema do
    ...
    swagger_schema :ConsultancyInputPut do
      allOf do
        schema do
          property :consultancy do
            key :'$ref', :Consultancy
    ...
    swagger_schema :ConsultancyOutput do
      allOf do
        schema do
          key :'$ref', :Consultancy
        end
    ...
    swagger_schema :ConsultancyDxOutput do
      allOf do
        schema do
          property :data do
            key :type, :array

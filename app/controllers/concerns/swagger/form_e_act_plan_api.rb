module Swagger::FormEActPlanApi
  ...
  included do
    ...
    swagger_path '/inventories/{id}' do
      operation :get do
        key :summary, 'Get a Form E action plan or inventory by ID'
        key :description, 'Returns a single form E action plan or inventory'
        key :operationId, :get_inventory_by_id
        key :produces, ['application/json',]
    ...
    swagger_path '/inventories' do
      operation :get do
        key :summary, 'Get all Form E action plans or inventories'
        key :description, 'Returns all form E action plans or inventories'
        key :operationId, :get_inventories
        key :produces, ['application/json',]
        key :tags, ['Projects::Inventories']
      ...
      operation :post do
        key :summary, 'Create a new Form E action plan or inventory'
        key :description, 'Returns the created form E action plan or inventory'
        key :operationId, :create_inventory
        key :produces, ['application/json',]
        key :tags, ['Projects::Inventories']

        parameter name: :form_e_act_plan do
          key :in, :body
          key :description, 'Form E action plan or inventory to register'
          key :required, true
          schema do
            key :'$ref', :FormEActPlanInputPost
          end

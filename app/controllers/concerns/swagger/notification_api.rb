module Swagger::NotificationApi
  ...
  included do
    ...
    swagger_path '/notifications/health_check' do
    ...
    swagger_path '/notifications' do
      ...
      operation :post do
        key :summary, 'Custom notification'
        key :description, 'Send mail with body and subject'
        key :operationId, :custom_notification
        key :produces, ['application/json',]
        key :tags, ['Notifications']

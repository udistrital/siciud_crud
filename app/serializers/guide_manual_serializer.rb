class GuideManualSerializer < AbstractProductSerializer
  attributes :id, :title, :date_of_publication, :url, :product_type_id,
             :product_type_name, :category_id, :category_name,

class MagazineEditionSerializer < AbstractProductSerializer
  attributes :id, :title, :editorial_name, :issn, :publication_year,
             :editorial_date, :category_id, :category_name,

class ConsultancySerializer < AbstractProductSerializer
  attributes :id, :title, :contract_number, :consulting_objective,
             :consultation_date, :category_id, :category_name,

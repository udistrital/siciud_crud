class ClinicalPracticeGuidelineSerializer < AbstractProductSerializer
  attributes :id, :title, :date_of_publication, :isbn, :category_id,
             :category_name, :colciencias_call_id,

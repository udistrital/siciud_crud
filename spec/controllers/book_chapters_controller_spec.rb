...
RSpec.describe BookChaptersController, type: :controller do
  ...
  # BookChapter. As you add validations to BookChapter, be sure to
  ...
  # BookChaptersController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new BookChapter" do
        ...
        }.to change(BookChapter, :count).by(1)
      end

      it "renders a JSON response with the new book_chapter" do

        post :create, params: {book_chapter: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(book_chapter_url(BookChapter.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new book_chapter" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested book_chapter" do
        book_chapter = BookChapter.create! valid_attributes
      ...
      it "renders a JSON response with the book_chapter" do
        book_chapter = BookChapter.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the book_chapter" do
        book_chapter = BookChapter.create! valid_attributes

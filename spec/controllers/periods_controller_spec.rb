...
RSpec.describe PeriodsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new period" do

        post :create, params: {period: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(period_url(Period.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new period" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the period" do
        period = Period.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the period" do
        period = Period.create! valid_attributes

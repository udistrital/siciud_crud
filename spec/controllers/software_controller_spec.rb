...
RSpec.describe SoftwareController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new software" do

        post :create, params: {software: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(software_url(Software.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new software" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the software" do
        software = Software.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the software" do
        software = Software.create! valid_attributes

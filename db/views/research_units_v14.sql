SELECT
    ...
    rg.mission,
    rg.snies_id,
    sn.code AS snies_code,
    sn.name AS snies_name,
    rg.vision,
    rg.colciencias_code,
    rg.group_type_id,
    ...
    ARRAY(SELECT r.identification_number FROM group_members gm LEFT JOIN researchers r ON gm.researcher_id  = r.id WHERE gm.research_group_id = rg.id) AS member_documents,
...
FROM research_groups rg
         ...
         LEFT JOIN snies sn on rg.snies_id = sn.id;
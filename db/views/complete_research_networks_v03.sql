SELECT rn.id,
       ...
       ARRAY(SELECT research_group_id FROM research_groups_research_networks WHERE research_network_id = rn.id) AS research_group_ids,
       (SELECT count(*) FROM research_groups_research_networks WHERE research_network_id = rn.id) AS research_group_count,
       rn.mission,
       rn.network_type_id,

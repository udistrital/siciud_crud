...
ActiveRecord::Schema.define(version: 2021_11_19_201329) do
  ...
  create_table "subtypes_prod", force: :cascade do |t|
    t.string "st_name"
    t.text "st_description"
    t.bigint "parent_id"
    t.bigint "type_id"
  ...
  create_table "types_prod", force: :cascade do |t|
    t.string "t_name", null: false
    t.text "t_description"
    t.datetime "created_at", default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.datetime "updated_at", default: -> { "CURRENT_TIMESTAMP" }, null: false
  ...
  SQL
  create_view "complete_consultancies", sql_definition: <<-SQL
      SELECT cns.id,
      cns.title,
      cns.category_id,
      st.st_name AS category_name,
  ...
  SQL
  create_view "complete_gm_periods", sql_definition: <<-SQL
      SELECT gp.id,
      gp.initial_date,
      gp.final_date,
      gp.group_member_id,
  ...
  SQL
  create_view "complete_affiliated_entities", sql_definition: <<-SQL
      SELECT ae.id,
  ...
  SQL
  create_view "complete_rg_research_networks", sql_definition: <<-SQL
      SELECT rgrn.id,
  ...
  SQL
  create_view "complete_entities", sql_definition: <<-SQL
      SELECT ent.id,
      ent.name,
      ent.nit,
      ent.check_digit,
  ...
  SQL
  create_view "complete_hist_lrs", sql_definition: <<-SQL
      SELECT hlr.id,
      hlr.entity_id,
      e.name AS entity_name,
  ...
  SQL
  create_view "complete_hist_contacts", sql_definition: <<-SQL
      SELECT hc.id,
      hc.contact_id,
  ...
  SQL
  create_view "complete_research_networks", sql_definition: <<-SQL
      SELECT rn.id,
      rn.name,
      rn.acronym,
  ...
  SQL
  create_view "complete_proposals", sql_definition: <<-SQL
      SELECT p.id,
      p.title,
      p.call_id,
      c.call_code,
